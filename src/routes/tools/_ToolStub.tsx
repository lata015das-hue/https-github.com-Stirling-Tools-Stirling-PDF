...
const TOOL_CATALOG: ReadonlyArray<CatalogEntry> = [
  ...
  { id: "crop",                   name: "Crop PDF",              category: "page-operations" },
  ...
  { id: "pdf-to-presentation",    name: "PDF to PowerPoint",     category: "convert" },
  ...
  { id: "remove-cert-sign",       name: "Remove Signatures",     category: "security" },
  { id: "sanitize-pdf",           name: "Sanitize PDF",          category: "security" },
  { id: "auto-redact",            name: "Auto Redact",           category: "security" },
  { id: "validate-signature",     name: "Validate Signature",    category: "security" },
  ...
  { id: "flatten",                name: "Flatten PDF",           category: "other" },
  { id: "update-metadata",        name: "Update Metadata",       category: "other" },
  { id: "remove-blanks",          name: "Remove Blank Pages",    category: "other" },
  { id: "remove-annotations",     name: "Remove Annotations",    category: "other" },
  { id: "get-info-on-pdf",        name: "PDF Info",              category: "other" },
  { id: "add-stamp",              name: "Add Stamp",             category: "other" },
  { id: "add-attachments",        name: "Add Attachments",       category: "other" },
  { id: "show-javascript",        name: "Show JavaScript",       category: "other" },
  { id: "edit-table-of-contents", name: "Edit Table of Contents", category: "other" },
  // advance
  { id: "compress-pdf",           name: "Compress PDF",          category: "advance" },
  { id: "repair",                 name: "Repair PDF",            category: "advance" },
  { id: "auto-rename",            name: "Auto Rename",           category: "advance" },
  { id: "extract-image-scans",    name: "Extract Scans",         category: "advance" },
  { id: "scanner-effect",         name: "Scanner Effect",        category: "advance" },
  { id: "replace-invert-pdf",     name: "Replace/Invert Colors", category: "advance" },
];
